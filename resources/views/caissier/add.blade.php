...
<html lang="en">
  ...
  <div class="card-body">
            <form action="{{route('caissier.store')}}" method="post">
                @csrf
                 <div class="input-group input-group-outline my-3">
                  <label class="form-label">nomCaissier</label>
                  <input type="text" class="form-control" name="nomCaissier">
                </div>
                <div class="input-group input-group-outline my-3">
                  <label class="form-label">prenomCaissier</label>
                ...
                <div class="input-group input-group-outline my-3">
                  ...
                  <option value="intermediiaire"></option>
